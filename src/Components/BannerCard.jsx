    ...
    <div className="w-10/12 mx-auto">
      <div className="card bg-base-100 w-96 shadow-sm mt-6">
        ...
        <div className="card-body">
          <h2 className="text-xl font-bold px-4 py-2 bg-pink-300 rounded-lg text-center uppercase">
            Name : <span className="text-blue-900">{foodName}</span>
          </h2>
          <div className="text-gray-400 text-xl items-center flex gap-2">
            <p>
              Quantity : <span>{foodQuantity}</span>
            </p>
            <h1 className="flex items-center gap-2">
              <MdAccessTimeFilled className="text-red-400" />{" "}
